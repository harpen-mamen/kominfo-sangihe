...
namespace App\Filament\Resources\Konten;

use App\Filament\Resources\Konten\Pages\ManageKonten;
...
class KontenResource extends Resource
{
    ...
    public static function form(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Konten Terpadu')
                ->schema([
                    Select::make('jenis_konten')->options(ResourceOptions::jenisKonten())->required(),
                    ...
                    Textarea::make('isi')->rows(8)->columnSpanFull(),
                    Textarea::make('uraian')->rows(6)->columnSpanFull(),
                ...
                ->columns(2),
            Section::make('Wilayah dan Publikasi')
                ->schema([
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->modifyQueryUsing(function (Builder $query): Builder {
                ...
                if ($user) {
                    $query = AdminScope::applyScope($query, $user, 'kecamatan_id', 'opd_id');
                }

                return $query->with(['kecamatan', 'desa', 'opd']);
            })
            ->columns([
                TextColumn::make('judul')->searchable()->sortable()->limit(42),
                TextColumn::make('jenis_konten')->badge(),
            ...
            ->filters([
                SelectFilter::make('jenis_konten')->options(ResourceOptions::jenisKonten()),
    ...
    {
        return ['index' => ManageKonten::route('/')];
    }
}
